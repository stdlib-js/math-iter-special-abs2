...
```javascript
import iterAbs2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs2@v0.2.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-abs2/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-iter-special-abs2/actions/workflows/test.yml?query=branch:v0.2.0
