...
```javascript
iterAbs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs2@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs2@umd/bundle.js"></script>
```
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-ops-add@umd/bundle.js"></script>
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs2@umd/bundle.js"></script>
<script type="text/javascript">
(function () {
