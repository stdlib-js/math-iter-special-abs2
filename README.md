...
```javascript
iterAbs2 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs2@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-abs2@v0.1.1-umd/browser.js"></script>
```
